...
const ROLE_LABEL: Record<Role, string> = {
  ceo: "CEO", admin: "Administrator", manager: "Manager", employee: "Employee",
};
    ...
    <div className="min-h-screen bg-[#0F1420] text-[#E7E4DC] flex">
      <aside className="w-60 shrink-0 border-r border-[#242B3D] flex flex-col">
        <div className="px-6 py-6 border-b border-[#242B3D]">
          <div className="text-[#C9A227] text-sm tracking-wide font-semibold">Industry</div>
          <div className="text-xs text-[#8B93A7] mt-1">AI Executive Decision Agent</div>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="px-8 py-6 border-b border-[#242B3D] flex items-baseline justify-between">
          <div>
            ...
            {subtitle && <p className="text-sm text-[#8B93A7] mt-1">{subtitle}</p>}
          </div>
